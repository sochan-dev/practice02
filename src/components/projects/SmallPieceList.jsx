...
export const SmallPieceList = (props) => {
    const classes = useStyles();

    const smallPieces = props.smallPieces;
    const length = smallPieces.length;
    ...
    return(
            <>
                {smallPieces.length > 0 && (
                    smallPieces.map((smallPiece,i) => (
                        <SmallPiece
                            key={i}
                            styles={classNames(
                                pieceHeight,
